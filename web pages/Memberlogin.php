    ...
    <!-------------SIDEBAR----------->
      ...
      <div id="content" class="p-4 p-md-5">
        <!-------------COMPLAINTS HISTORY TABLE----------->
          <div class="column">
    <h1 style="text-align:center;">MEMBER LOGIN</h1><br>
    <form method="POST" action="Memberlogintest.php">
  Username
