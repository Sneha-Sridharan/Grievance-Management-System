...
<html lang="en">
  ...
  <body>
    ...
    <section id="main">
        <form class="reg-form" method="POST" action="reset_pwd_student_test.php">
            <h2 class="reg-form-title" style="text-align: center;"><b>RESET PASSWORD</b></h2>
