<?php
	session_start();
	if(isset($_SESSION['add_complaints_faculty_error']))
	{	
		...
		unset($_SESSION['add_complaints_faculty_error']);
	}
?>
<!doctype html>
<html lang="en">
  ...
  <body>
    ...
    <section id="main">
        <form class="reg-form" method="POST" action="add-complaints-faculty-test.php">
